...
pip install git+ssh://git@github.com/the-opennet-foundation/solana.wallet.router-api-python.git
```
...
```sh
# install from the production repo
pip install 'solana.wallet.router_api[aiohttp] @ git+ssh://git@github.com/the-opennet-foundation/solana.wallet.router-api-python.git'
```
...
These methods return an [`APIResponse`](https://github.com/the-opennet-foundation/solana.wallet.router-api-python/tree/main/src/solana/wallet/router_api/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/the-opennet-foundation/solana.wallet.router-api-python/tree/main/src/solana/wallet/router_api/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/the-opennet-foundation/solana.wallet.router-api-python/issues) with questions, bugs, or suggestions.
